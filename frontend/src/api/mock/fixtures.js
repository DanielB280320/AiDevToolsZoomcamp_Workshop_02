// Reference data for the mock backend. Squads and results are generated from these seeds
// in generate.js, so the (fictional) season is the same on every run.
...
export const CLUBS = Object.fromEntries(
  CLUB_ROWS.map(([id, name, code, color, namePool, logo]) => [id, { name, code, color, namePool, logo }]),
);

// `clubIds` are listed roughly strongest-first; generate.js uses the order as team strength.
export const LEAGUES = [
  {
    id: 'premier-league', name: 'Premier League', country: 'England', region: 'Europe', code: 'ENG', logo: 'https://r2.thesportsdb.com/images/media/league/badge/gasy9d1737743125.png/small', season: '2026–27', color: '#3D1159',
    format: 'double', roundsPlayed: 12,
    clubIds: ['liverpool', 'arsenal', 'manchester-city', 'chelsea', 'newcastle-united', 'aston-villa', 'tottenham-hotspur', 'manchester-united', 'brighton', 'nottingham-forest'],
  },
  {
    id: 'la-liga', name: 'La Liga', country: 'Spain', region: 'Europe', code: 'ESP', logo: 'https://r2.thesportsdb.com/images/media/league/badge/ja4it51687628717.png/small', season: '2026–27', color: '#D6312B',
    format: 'double', roundsPlayed: 12,
    clubIds: ['barcelona', 'real-madrid', 'atletico-madrid', 'athletic-club', 'villarreal', 'real-betis', 'real-sociedad', 'celta-vigo', 'sevilla', 'valencia'],
  },
  {
    id: 'serie-a', name: 'Serie A', country: 'Italy', region: 'Europe', code: 'ITA', logo: 'https://r2.thesportsdb.com/images/media/league/badge/67q3q21679951383.png/small', season: '2026–27', color: '#1B4FA0',
    format: 'double', roundsPlayed: 12,
    clubIds: ['napoli', 'inter', 'atalanta', 'juventus', 'roma', 'milan', 'lazio', 'bologna', 'fiorentina', 'como'],
  },
  {
    id: 'bundesliga', name: 'Bundesliga', country: 'Germany', region: 'Europe', code: 'GER', logo: 'https://r2.thesportsdb.com/images/media/league/badge/teqh1b1679952008.png/small', season: '2026–27', color: '#C8102E',
    format: 'double', roundsPlayed: 12,
    clubIds: ['bayern-munich', 'bayer-leverkusen', 'eintracht-frankfurt', 'borussia-dortmund', 'sc-freiburg', 'mainz-05', 'rb-leipzig', 'werder-bremen', 'vfb-stuttgart', 'borussia-monchengladbach'],
  },
  {
    id: 'brasileirao', name: 'Brasileirão Série A', country: 'Brazil', region: 'Americas', code: 'BRA', logo: 'https://r2.thesportsdb.com/images/media/league/badge/lywv7t1766787179.png/small', season: '2026', color: '#00843D',
    format: 'double', roundsPlayed: 12,
    clubIds: ['flamengo', 'palmeiras', 'cruzeiro', 'botafogo', 'fluminense', 'sao-paulo', 'internacional', 'corinthians', 'atletico-mineiro', 'gremio'],
  },
  {
    id: 'liga-mx', name: 'Liga MX', country: 'Mexico', region: 'Americas', code: 'MEX', logo: 'https://r2.thesportsdb.com/images/media/league/badge/mav5rx1686157960.png/small', season: '2026–27', color: '#0B6E4F',
    format: 'double', roundsPlayed: 12,
    clubIds: ['toluca', 'club-america', 'cruz-azul', 'tigres-uanl', 'monterrey', 'pachuca', 'guadalajara', 'pumas-unam', 'tijuana', 'leon'],
  },
  {
    id: 'mls', name: 'MLS', country: 'USA / Canada', region: 'Americas', code: 'USA', logo: 'https://r2.thesportsdb.com/images/media/league/badge/dqo6r91549878326.png/small', season: '2026', color: '#1B2F5E',
    format: 'double', roundsPlayed: 12,
    clubIds: ['inter-miami', 'la-galaxy', 'columbus-crew', 'fc-cincinnati', 'lafc', 'seattle-sounders', 'philadelphia-union', 'orlando-city', 'vancouver-whitecaps', 'new-york-city-fc'],
  },
  {
    id: 'primera-division', name: 'Primera División', country: 'Argentina', region: 'Americas', code: 'ARG', logo: 'https://r2.thesportsdb.com/images/media/league/badge/rk9xhx1768238251.png/small', season: '2026', color: '#2A6FB0',
    format: 'double', roundsPlayed: 12,
    clubIds: ['river-plate', 'boca-juniors', 'racing-club', 'independiente', 'velez-sarsfield', 'estudiantes', 'talleres', 'san-lorenzo', 'rosario-central', 'huracan'],
  },
  {
    id: 'champions-league', name: 'UEFA Champions League', country: 'Europe', region: 'Continental', code: 'UCL', logoBackground: '#0B1F63',logo: 'https://r2.thesportsdb.com/images/media/league/badge/facv1u1742998896.png/small', season: '2026–27', color: '#0B1F63',
    format: 'single', roundsPlayed: 8,
    clubIds: ['real-madrid', 'bayern-munich', 'liverpool', 'arsenal', 'barcelona', 'inter', 'paris-saint-germain', 'manchester-city', 'atletico-madrid', 'borussia-dortmund'],
  },
];
